...
class ClickHouseTestSettings extends BackendTestSettings {
  ...
  // skip core dump cases and slow cases
  enableSuite[GlutenCSVSuite]
    .exclude(csvCoreDumpCases: _*)
    ...
    .exclude("SPARK-30530: apply filters to malformed rows")
  ...
  enableSuite[GlutenDataFrameTungstenSuite]
    .exclude("Map type with struct type as key")
  ...
  enableSuite[GlutenDynamicPartitionPruningV1SuiteAEOff]
    .exclude("Gluten - SPARK-32659: Fix the data issue when pruning DPP on non-atomic type")
  ...
  enableSuite[GlutenMathFunctionsSuite]
    .exclude("conv")
    .exclude("SPARK-33428 conv function should trim input string")
    .exclude("SPARK-33428 conv function shouldn't raise error if input string is too big")
    .exclude(
      "SPARK-36229 inconsistently behaviour where returned value is above the 64 char threshold")
    .exclude("SPARK-36229 conv should return result equal to -1 in base of toBase")
    .exclude("csc")
    .exclude("sec")
  ...
  enableSuite[GlutenDataSourceV2SQLSuite]
    .exclude("DeleteFrom: fail if has subquery")
  ...
  enableSuite[GlutenMetadataColumnSuite]
    .exclude("SPARK-34923: do not propagate metadata columns through View")
